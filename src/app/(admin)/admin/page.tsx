                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap items-center gap-1.5 mt-0.5">
                              <span className="text-[11px] text-slate-500 dark:text-slate-400 font-mono">
                                {u.email || u.phone_number || 'No contact set'}
                              </span>
                              {u.email && (
                                <span
                                  className={`inline-flex items-center gap-0.5 px-1.5 py-0.2 text-[9px] font-bold uppercase tracking-wider rounded border ${
                                    u.is_email_verified
                                  ...
                                  title={
                                    u.is_email_verified
                                      ? `Verified email${u.email_confirmed_at ? ` (${formatDate(u.email_confirmed_at)})` : ''}`
                      ...
                      <td className="py-3.5 px-4 text-right" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center justify-end gap-1.5">
                          {u.email && (
                            <button
                              onClick={() => setSelectedDetailUser(u)}
                              className="px-2 py-1.5 rounded-lg bg-brand-orange/10 hover:bg-brand-orange/20 text-brand-orange border border-brand-orange/20 text-[11px] font-bold transition-all flex items-center gap-1"
                              title={`Send branded email to ${u.email}`}
                            >
