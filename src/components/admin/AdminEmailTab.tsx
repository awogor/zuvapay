          ...
          <div className="space-y-4 text-xs">
            ...
            <div>
              ...
              >
                ...
                <option value="email_verification">2. Email Verification</option>
                <option value="password_reset">3. Password Reset</option>
                <option value="wallet_credit">4. Wallet Credited Alert</option>
                <option value="service_receipt">5. Purchase Receipt</option>
                <option value="electricity_token">6. Electricity Meter Token</option>
                <option value="refund_alert">7. Refund Confirmation</option>
                <option value="security_pin">8. Security Alert</option>
