...
export function ForgotPasswordPageView() {
  ...
  return (
    <div className="min-h-screen sm:h-screen sm:max-h-screen w-full flex flex-col justify-center items-center p-4 sm:p-0 bg-white sm:bg-[#FFF9F3] sm:bg-gradient-to-br sm:from-[#FFF5EC] sm:via-[#FFF9F4] sm:to-[#FFF0E2] relative overflow-y-auto sm:overflow-hidden selection:bg-brand-orange selection:text-white">
      ...
      {/* Form Container - Stays exactly in the middle on desktop with zero scrolling */}
      <div className="relative z-10 w-full max-w-[400px] rounded-3xl border-0 sm:border sm:border-slate-200/90 bg-white p-4 sm:p-6 sm:shadow-[0_20px_50px_-12px_rgba(255,107,0,0.12),0_8px_24px_-8px_rgba(15,23,42,0.06)] sm:ring-1 sm:ring-slate-900/5 my-auto sm:my-0">
