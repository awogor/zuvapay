      ...
      <div className="flex items-center gap-3">
        ...
        {onOpenFundModal && (
          <button
            ...
            className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-brand-orange/15 hover:bg-brand-orange/25 border border-brand-orange/30 text-brand-orange text-xs font-bold transition-all"
          >
